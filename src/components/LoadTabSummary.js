...
class LoadTabSummary extends Component {
          ...
          <div>
            ...
            <div className="card-notebook sticky-note shadow">
              ...
              <div className="d-flex justify-content-start">
                ...
                <div className="load-summary-detail">{Number(wtokwUp(day_energy_wh)) + Number(wtokwUp(night_energy_wh))}</div>
                <div className="load-summary-units">kWhr</div>
              </div>
              <hr />
              <div className="d-flex justify-content-start">
